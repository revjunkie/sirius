...
static struct of_device_id msm_slp_sts_match_tbl[] __refdata= {
...
static struct of_device_id msm_snoc_clnt_match_tbl[] __refdata = {
...
static struct of_device_id msm_cpu_pm_table[] __refdata = {
